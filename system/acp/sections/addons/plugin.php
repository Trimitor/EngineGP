<?php
	...
	if($go)
	{
		...
		$sql->query('DELETE FROM `plugins__config` WHERE `plugin`="'.$id.'" AND `update`="0"');
		...
		foreach($aData['config_files_file'] as $i => $file)
		{
			...
			$sql->query('INSERT INTO `plugins__config` set `plugin`="'.$id.'", `update`="0", `file`="'.$file.'", `sort`="'.$n.'"');
		}

		if($n)
			$aData['cfg'] = 1;

		$sql->query('DELETE FROM `plugins__clear` WHERE `plugin`="'.$id.'" AND `update`="0"');
		...
		foreach($aData['config_clear_file'] as $i => $file)
		{
			...
			$sql->query('INSERT INTO `plugins__clear` set `plugin`="'.$id.'", `update`="0", `text`="'.$text.'", `file`="'.$file.'", `regex`="'.$regex.'"');
		}

		$sql->query('DELETE FROM `plugins__write` WHERE `plugin`="'.$id.'" AND `update`="0"');
		...
		foreach($aData['config_write_file'] as $i => $file)
		{
			...
			$sql->query('INSERT INTO `plugins__write` set `plugin`="'.$id.'", `update`="0", `text`="'.$text.'", `file`="'.$file.'", `top`="'.$top.'"');
		}

		$sql->query('DELETE FROM `plugins__write_del` WHERE `plugin`="'.$id.'" AND `update`="0"');
		...
		foreach($aData['config_write_del_file'] as $i => $file)
		{
			...
			$sql->query('INSERT INTO `plugins__write_del` set `plugin`="'.$id.'", `update`="0", `text`="'.$text.'", `file`="'.$file.'", `top`="'.$top.'"');
		}

		$sql->query('DELETE FROM `plugins__delete` WHERE `plugin`="'.$id.'" AND `update`="0"');
		...
		foreach($aData['files_delete_file'] as $file)
		{
			...
			$sql->query('INSERT INTO `plugins__delete` set `plugin`="'.$id.'", `update`="0", `file`="'.$file.'"');
		}

		if($aData['delete'])
		{
			$sql->query('DELETE FROM `plugins__delete_ins` WHERE `plugin`="'.$id.'" AND `update`="0" LIMIT 1');

			$sql->query('INSERT INTO `plugins__delete_ins` set `plugin`="'.$id.'", `update`="0", `file`="'.$aData['delete'].'"');
		}
	...
	$html->get('plugin', 'sections/addons');
		...
		$sql->query('SELECT `id`, `name` FROM `plugins__category` WHERE `game`="'.$plugin['game'].'" ORDER BY `sort` ASC');
		while($cat = $sql->get())
		...
		$sql->query('SELECT `id`, `file`, `sort` FROM `plugins__config` WHERE `plugin`="'.$id.'" AND `update`="0" ORDER BY `sort` ASC');
		while($data = $sql->get())
		{
		...
		$sql->query('SELECT `id`, `text`, `file`, `regex` FROM `plugins__clear` WHERE `plugin`="'.$id.'" AND `update`="0" ORDER BY `id` ASC');
		while($data = $sql->get())
		{
		...
		$sql->query('SELECT `id`, `text`, `file`, `top` FROM `plugins__write` WHERE `plugin`="'.$id.'" AND `update`="0" ORDER BY `id` ASC');
		while($data = $sql->get())
		{
		...
		$sql->query('SELECT `id`, `text`, `file`, `top` FROM `plugins__write_del` WHERE `plugin`="'.$id.'" AND `update`="0" ORDER BY `id` ASC');
		while($data = $sql->get())
		{
			$top = $data['top'] ? 'checked' : '';
		...
		$sql->query('SELECT `id`, `file` FROM `plugins__delete` WHERE `plugin`="'.$id.'" AND `update`="0" ORDER BY `id` ASC');
		while($data = $sql->get())
		{
		...
		$sql->query('SELECT `id`, `name`, `status` FROM `plugins__update` WHERE `plugin`="'.$id.'" ORDER BY `id` ASC');
		while($data = $sql->get())
		{
			$update .= '<tr>';
