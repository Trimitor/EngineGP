...
--
-- Структура таблицы `address__buy`
--

CREATE TABLE `address__buy` (
  `id` int(11) NOT NULL,
  `aid` int(11) NOT NULL,
...
--
-- Структура таблицы `admins__crmp`
--

CREATE TABLE `admins__crmp` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `admins__cs`
--

CREATE TABLE `admins__cs` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
...
--
-- Структура таблицы `admins__csgo`
--

CREATE TABLE `admins__csgo` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `value` varchar(50) NOT NULL,
...
--
-- Структура таблицы `admins__css`
--

CREATE TABLE `admins__css` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `value` varchar(50) NOT NULL,
...
--
-- Структура таблицы `admins__cssold`
--

CREATE TABLE `admins__cssold` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `value` varchar(50) NOT NULL,
...
--
-- Структура таблицы `admins__mc`
--

CREATE TABLE `admins__mc` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `admins__mta`
--

CREATE TABLE `admins__mta` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `admins__samp`
--

CREATE TABLE `admins__samp` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `boost__rating`
--

CREATE TABLE `boost__rating` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `control__admins_cs`
--

CREATE TABLE `control__admins_cs` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `value` varchar(50) NOT NULL,
...
--
-- Структура таблицы `control__admins_csgo`
--

CREATE TABLE `control__admins_csgo` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `value` varchar(50) NOT NULL,
...
--
-- Структура таблицы `control__admins_css`
--

CREATE TABLE `control__admins_css` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `value` varchar(50) NOT NULL,
...
--
-- Структура таблицы `control__admins_cssold`
--

CREATE TABLE `control__admins_cssold` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `value` varchar(50) NOT NULL,
...
--
-- Структура таблицы `control__boost`
--

CREATE TABLE `control__boost` (
  `id` int(11) NOT NULL,
  `user` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `site` varchar(20) NOT NULL,
...
--
-- Структура таблицы `control__copy`
--

CREATE TABLE `control__copy` (
  `id` int(11) NOT NULL,
  `user` text,
...
--
-- Структура таблицы `control__crontab`
--

CREATE TABLE `control__crontab` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
...
--
-- Структура таблицы `control__firewall`
--

CREATE TABLE `control__firewall` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
...
--
-- Структура таблицы `control__plugins_buy`
--

CREATE TABLE `control__plugins_buy` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `control__plugins_install`
--

CREATE TABLE `control__plugins_install` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
...
--
-- Структура таблицы `control__servers`
--

CREATE TABLE `control__servers` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `graph__day`
--

CREATE TABLE `graph__day` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
...
--
-- Структура таблицы `graph__hour`
--

CREATE TABLE `graph__hour` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `online` int(11) NOT NULL,
  `cpu` int(11) NOT NULL,
...
--
-- Структура таблицы `help__dialogs`
--

CREATE TABLE `help__dialogs` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `help__upload`
--

CREATE TABLE `help__upload` (
  `id` int(11) NOT NULL,
  `user` int(11) NOT NULL,
...
--
-- Структура таблицы `jobs__app`
--

CREATE TABLE `jobs__app` (
  `id` int(11) NOT NULL,
  `user` int(11) NOT NULL,
  `text` text NOT NULL,
...
--
-- Структура таблицы `logs__sys`
--

CREATE TABLE `logs__sys` (
  `id` int(11) NOT NULL,
  `user` int(11) NOT NULL,
...
--
-- Структура таблицы `plugins__buy`
--

CREATE TABLE `plugins__buy` (
  `id` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
  `key` varchar(32) NOT NULL,
  `server` int(11) NOT NULL,
...
--
-- Структура таблицы `plugins__category`
--

CREATE TABLE `plugins__category` (
  `id` int(11) NOT NULL,
  `game` char(6) NOT NULL,
  `name` varchar(50) NOT NULL,
  `sort` int(11) NOT NULL
...
--
-- Структура таблицы `plugins__clear`
--

CREATE TABLE `plugins__clear` (
  `id` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
...
--
-- Структура таблицы `plugins__config`
--

CREATE TABLE `plugins__config` (
  `id` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
  `update` int(11) NOT NULL,
  `file` varchar(100) NOT NULL,
...
--
-- Структура таблицы `plugins__delete`
--

CREATE TABLE `plugins__delete` (
  `id` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
  `update` int(11) NOT NULL,
  `file` varchar(100) NOT NULL
...
--
-- Структура таблицы `plugins__delete_ins`
--

CREATE TABLE `plugins__delete_ins` (
  `id` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
  `update` int(11) NOT NULL,
...
--
-- Структура таблицы `plugins__install`
--

CREATE TABLE `plugins__install` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
  `upd` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `plugins__update`
--

CREATE TABLE `plugins__update` (
  `id` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `desc` text,
...
--
-- Структура таблицы `plugins__write`
--

CREATE TABLE `plugins__write` (
  `id` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
  `update` int(11) NOT NULL,
  `text` varchar(100) NOT NULL,
...
--
-- Структура таблицы `plugins__write_del`
--

CREATE TABLE `plugins__write_del` (
  `id` int(11) NOT NULL,
  `plugin` int(11) NOT NULL,
  `update` int(11) NOT NULL,
  `text` varchar(100) NOT NULL,
...
--
-- Структура таблицы `privileges__buy`
--

CREATE TABLE `privileges__buy` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
  `text` text NOT NULL,
  `sql` text NOT NULL,
...
--
-- Структура таблицы `privileges__list`
--

CREATE TABLE `privileges__list` (
  `id` int(11) NOT NULL,
  `server` int(11) NOT NULL,
...
--
-- Структура таблицы `promo__use`
--

CREATE TABLE `promo__use` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `servers` (
  ...
  `plugins__use` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `tarifs` (
  ...
  `plugins__install` text NOT NULL,
  `hdd` int(11) NOT NULL,
...
INSERT INTO `tarifs` (`id`, `unit`, `game`, `name`, `slots_min`, `slots_max`, `port_min`, `port_max`, `hostname`, `packs`, `path`, `install`, `update`, `fps`, `tickrate`, `ram`, `param_fix`, `time`, `timext`, `test`, `tests`, `discount`, `map`, `ftp`, `plugins`, `console`, `stats`, `copy`, `web`, `plugins__install`, `hdd`, `autostop`, `price`, `core_fix`, `ip`, `show`, `sort`) VALUES
...
--
-- Структура таблицы `wiki__answer`
--

CREATE TABLE `wiki__answer` (
...
--
-- Структура таблицы `wiki__category`
--

CREATE TABLE `wiki__category` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `sort` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Индексы таблицы `address__buy`
--
ALTER TABLE `address__buy`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `admins__crmp`
--
ALTER TABLE `admins__crmp`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `admins__cs`
--
ALTER TABLE `admins__cs`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `admins__csgo`
--
ALTER TABLE `admins__csgo`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `admins__css`
--
ALTER TABLE `admins__css`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `admins__cssold`
--
ALTER TABLE `admins__cssold`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `admins__mc`
--
ALTER TABLE `admins__mc`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `admins__mta`
--
ALTER TABLE `admins__mta`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `admins__samp`
--
ALTER TABLE `admins__samp`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `boost__rating`
--
ALTER TABLE `boost__rating`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `control__admins_cs`
--
ALTER TABLE `control__admins_cs`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__admins_csgo`
--
ALTER TABLE `control__admins_csgo`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__admins_css`
--
ALTER TABLE `control__admins_css`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__admins_cssold`
--
ALTER TABLE `control__admins_cssold`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__boost`
--
ALTER TABLE `control__boost`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__copy`
--
ALTER TABLE `control__copy`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__crontab`
--
ALTER TABLE `control__crontab`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__firewall`
--
ALTER TABLE `control__firewall`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__plugins_buy`
--
ALTER TABLE `control__plugins_buy`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__plugins_install`
--
ALTER TABLE `control__plugins_install`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `control__servers`
--
ALTER TABLE `control__servers`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `graph__day`
--
ALTER TABLE `graph__day`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `graph__hour`
--
ALTER TABLE `graph__hour`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `help__dialogs`
--
ALTER TABLE `help__dialogs`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `help__upload`
--
ALTER TABLE `help__upload`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `jobs__app`
--
ALTER TABLE `jobs__app`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `logs__sys`
--
ALTER TABLE `logs__sys`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `plugins__buy`
--
ALTER TABLE `plugins__buy`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__category`
--
ALTER TABLE `plugins__category`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__clear`
--
ALTER TABLE `plugins__clear`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__config`
--
ALTER TABLE `plugins__config`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__delete`
--
ALTER TABLE `plugins__delete`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__delete_ins`
--
ALTER TABLE `plugins__delete_ins`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__install`
--
ALTER TABLE `plugins__install`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__update`
--
ALTER TABLE `plugins__update`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__write`
--
ALTER TABLE `plugins__write`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `plugins__write_del`
--
ALTER TABLE `plugins__write_del`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `privileges__buy`
--
ALTER TABLE `privileges__buy`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `privileges__list`
--
ALTER TABLE `privileges__list`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `promo__use`
--
ALTER TABLE `promo__use`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `wiki__answer`
--
ALTER TABLE `wiki__answer`
  ADD PRIMARY KEY (`wiki`);

--
-- Индексы таблицы `wiki__category`
--
ALTER TABLE `wiki__category`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `address__buy`
--
ALTER TABLE `address__buy`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `admins__crmp`
--
ALTER TABLE `admins__crmp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `admins__cs`
--
ALTER TABLE `admins__cs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `admins__csgo`
--
ALTER TABLE `admins__csgo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `admins__css`
--
ALTER TABLE `admins__css`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `admins__cssold`
--
ALTER TABLE `admins__cssold`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `admins__mc`
--
ALTER TABLE `admins__mc`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `admins__mta`
--
ALTER TABLE `admins__mta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `admins__samp`
--
ALTER TABLE `admins__samp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `boost`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `boost__rating`
--
ALTER TABLE `boost__rating`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `control`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `control__admins_cs`
--
ALTER TABLE `control__admins_cs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `control__boost`
--
ALTER TABLE `control__boost`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `control__copy`
--
ALTER TABLE `control__copy`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `control__crontab`
--
ALTER TABLE `control__crontab`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `control__firewall`
--
ALTER TABLE `control__firewall`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `control__plugins_buy`
--
ALTER TABLE `control__plugins_buy`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `control__plugins_install`
--
ALTER TABLE `control__plugins_install`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `control__servers`
--
ALTER TABLE `control__servers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `graph`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `graph__day`
--
ALTER TABLE `graph__day`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `graph__hour`
--
ALTER TABLE `graph__hour`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `help`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `help__dialogs`
--
ALTER TABLE `help__dialogs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `help__upload`
--
ALTER TABLE `help__upload`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `jobs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `jobs__app`
--
ALTER TABLE `jobs__app`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `logs__sys`
--
ALTER TABLE `logs__sys`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `plugins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__buy`
--
ALTER TABLE `plugins__buy`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__category`
--
ALTER TABLE `plugins__category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__clear`
--
ALTER TABLE `plugins__clear`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__config`
--
ALTER TABLE `plugins__config`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__delete`
--
ALTER TABLE `plugins__delete`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__delete_ins`
--
ALTER TABLE `plugins__delete_ins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__install`
--
ALTER TABLE `plugins__install`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__update`
--
ALTER TABLE `plugins__update`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__write`
--
ALTER TABLE `plugins__write`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `plugins__write_del`
--
ALTER TABLE `plugins__write_del`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `privileges`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `privileges__buy`
--
ALTER TABLE `privileges__buy`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `privileges__list`
--
ALTER TABLE `privileges__list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `promo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `promo__use`
--
ALTER TABLE `promo__use`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `wiki`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `wiki__answer`
--
ALTER TABLE `wiki__answer`
  MODIFY `wiki` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `wiki__category`
--
ALTER TABLE `wiki__category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
